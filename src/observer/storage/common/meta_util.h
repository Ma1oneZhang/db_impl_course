...
[[__maybe_unused__]]static const char *TABLE_META_SUFFIX = ".table";
[[__maybe_unused__]]static const char *TABLE_META_FILE_PATTERN = ".*\\.table$";
[[__maybe_unused__]]static const char *TABLE_DATA_SUFFIX = ".data";
[[__maybe_unused__]]static const char *TABLE_INDEX_SUFFIX = ".index";
